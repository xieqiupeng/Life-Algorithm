...
git pull origin
cd %ROOT%\1_Algorithm-Me\1.2_Daily-Life
git pull origin
cd %ROOT%\1_Algorithm-Me\1.3_Money-Flow
git pull origin

cd %ROOT%\2_Customer-Profile
git pull origin
cd %ROOT%\2_Customer-Profile\2.1_Tutorial
git pull origin
cd %ROOT%\2_Customer-Profile\2.2_My-Dear-Girl
git pull origin
cd %ROOT%\2_Customer-Profile\2.3_Relationship
git pull origin
cd %ROOT%\2_Customer-Profile\2.4_Ecology
git pull origin
cd %ROOT%\2_Customer-Profile\2.5_Career
git pull origin
